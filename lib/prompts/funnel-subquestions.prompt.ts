...
export const FUNNEL_SUBQUESTIONS_PROMPT = [
  ...
  "### Example",
  "",
  '* **Original Question**: "How do different dressing types improve wound healing outcomes?"',
  "* **Sub-Questions Breakdown**:",
  "",
  "  1. **Step 1**: What are the different dressing types used?",
  "  2. **Step 2**: What are the healing outcomes for each dressing type?",
  "  3. **Step 3**: How do healing outcomes compare across dressing types?",
  "",
