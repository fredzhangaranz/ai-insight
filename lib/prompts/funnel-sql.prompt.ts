...
export const FUNNEL_SQL_PROMPT = [
  ...
  "```",
  "",
  "**IMPORTANT**: When writing SQL queries in the JSON, use single-line format or properly escape newlines with \\n. Do not use actual line breaks in the JSON string values.",
  "",
