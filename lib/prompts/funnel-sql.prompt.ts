...
export const FUNNEL_SQL_PROMPT = [
  ...
  '  "generatedSql": "The incremental optimized SQL query",',
  '  "validationNotes": "Any validation rules or data checks applied",',
  '  "matchedQueryTemplate": "Template name if matched, otherwise \'None\'"',
  "}",
  "```",
  "",
  "## Instructions for Incremental Query Generation",
  "",
  "1. **Utilize Previous Steps:**",
  "   * Leverage data generated from previous queries (e.g., use CTEs or reference previous result sets).",
  "   * Clearly reference results from earlier steps, and if applicable, use consistent CTE names for chaining.",
  "   * If provided, use the previous query or its result structure as context.",
  "",
  ...
  '  "generatedSql": "SELECT DISTINCT dressingType FROM rpt.Dressing",',
  '  "validationNotes": "Ensured dressingType is non-null and valid.",',
